...
inline PyObject * _JyObject_New(PyTypeObject *tp, TypeMapEntry* tme)
{
	...
	if (tme != NULL)
	{
		...
		if (PyObject_IS_GC(op)) puts("conflict: Macro PyObject_IS_GC indicates GC although object was created in _PyObject_New");
...
//In Jython: v is "this", w is "other".
static int
...
{
	//puts("PyObject_GetAttr, PyObject key");
...
_PyObject_GenericGetAttrWithDict(PyObject *obj, PyObject *name, PyObject *dict)
{
	 ...
	 * We aproach this issue by a temporary workaround:
	 * Do attr-lookup by hand:
	 * Try to retrive attr via
