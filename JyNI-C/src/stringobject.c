/* This File is based on stringobject.c from CPython 2.7.3 release.
...
PyString_FromString(const char *str)
{
	...
	PyObject_INIT_VAR(op, &PyString_Type, size);
//	puts("new string allocated:");
//	puts(PyString_AS_STRING(op));
//	puts("initial ref-count:");
...
_PyString_Resize(PyObject **pv, Py_ssize_t newsize)
{
	...
	//JyNI: We assume that no further use of the JyObject-fields has occured, if
