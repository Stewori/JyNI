/* This File is based on descrobject.c from CPython 2.7.3 release.
...
PyTypeObject PyDictProxy_Type = {
	...
	0, //&proxy_as_mapping,						  /* tp_as_mapping */
	0,										  /* tp_hash */
	0,										  /* tp_call */
...
PyTypeObject PyProperty_Type = {
	...
	0,										  /* tp_base */
	0,										  /* tp_dict */
	0,//property_descr_get,						 /* tp_descr_get */
	0,//property_descr_set,						 /* tp_descr_set */
	0,										  /* tp_dictoffset */
