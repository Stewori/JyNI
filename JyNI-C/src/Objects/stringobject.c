/* This File is based on stringobject.c from CPython 2.7 (latest repository version).
...
JyNIDebug(JY_NATIVE_ALLOC | JY_INLINE_MASK, op, jy, basicsize, PyString_Type.tp_name)
