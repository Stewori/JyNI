...
//	jputs("JyErr_InsertCurExc");
//	jputsLong(tstate);
//	jputsLong(tstate->curexc_type);
//	jputsLong(tstate->curexc_value);
//	jputsLong(tstate->curexc_traceback);
//	JyNI_jprintJ(TS_GET_JY(tstate));
	env();
